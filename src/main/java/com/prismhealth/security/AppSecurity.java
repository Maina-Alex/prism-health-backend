...
public class AppSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable() // disable csrf for our requests.
                ...
                .antMatchers(HttpMethod.POST, "/admin/providers").permitAll().antMatchers("/admin/posts/**").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/services/user/provider").authenticated()
                .antMatchers(HttpMethod.GET, "/catalog/productByProvider").authenticated()
